...
class SpecificationCategory(models.Model):
    ...
    measurement_unit = models.CharField(max_length=255, verbose_name='Unit of measurement', null=True, blank=True)
...
class Specification(models.Model):
    category = models.ForeignKey(SpecificationCategory, on_delete=models.CASCADE, verbose_name='Specification category',
